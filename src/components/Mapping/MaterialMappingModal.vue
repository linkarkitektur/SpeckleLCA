							...
							<div class="flex pb-2 h-full justify-between items-center">
								...
								>
									<div class="w-full p-2">
										<MappingCard
											class="bg-gray-400 focus:ring-gray-600"
											:group="selectedGroup"
										/>
									</div>
									<div
									...
									>
										...
										></div>
										<div
											class="border-t-2 border-dashed border-neutral-400 flex-grow pr-10 max-h-2 place-self-center"
										></div>
										<MappingCard
											class="ml-1 p-2 flex-grow w-5/6 bg-gray-200"
											:group="group"
										/>
									</div>
								</div>
