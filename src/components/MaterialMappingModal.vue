<template>
	<TransitionRoot as="template" :show="mappingModalOpen">
		<ProjectDialog as="div" class="relative z-50" @close="closeModal">
			...
			<div
				class="fixed justify-center items-center inset-0 left-[12.5%] z-50 p-10 w-screen h-screen"
			>
				<div
						...
						>
							<div class="flex pb-2 h-full justify-between items-center">
								...
								>
									...
									>
										<div
											class="border-l-2 border-dashed h-6 border-neutral-400 m-1"
										></div>
								...
								<div class="w-1/2 h-full overflow-y-scroll overflow-x-hidden">
									...
									<div class="relative mt-1 flex-1 px-4 sm:px-6">
										...
										<!-- Table -->
										<table
											class="divide-y divide-gray-200 max-w-full block table-fixed"
										>
											<thead class="w-full block">
												<tr
													class="w-full flex bg-gray-200 text-gray-700 text-left text-xs leading-4 font-medium uppercase tracking-wider whitespace-nowrap"
												>
											...
											<tbody
												class="bg-gray-100 divide-y divide-gray-300 max-w-full block table-fixed"
											>
												<tr
												...
												>
													<td class="m-2 w-2/6 line-clamp-3">
														{{ material.name }}
													</td>
													...
													<td
														:class="{
															'text-red-600':
																roundedEmissions[index].isPositive,
															'text-green-600':
																!roundedEmissions[index].isPositive
														}"
														class="m-2 w-1/6"
