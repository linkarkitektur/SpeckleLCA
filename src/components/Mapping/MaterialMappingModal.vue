  ...
  <TransitionRoot as="template" :show="mappingModalOpen">
    <Dialog as="div" class="relative z-50" @close="closeModal">
      ...
      <div class="fixed justify-center items-center inset-0 left-[12.5%] z-50 p-10 w-screen h-screen">
        <div class="w-3/4 flex flex-col items-end justify-center p-4 text-center sm:items-center sm:p-0 h-full">
          <TransitionChild
            as="template"
            enter="ease-out duration-300"
          ...
          >
            <DialogPanel class="transform rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all min-w-full h-full sm:my-8 sm:max-w-sm sm:p-6">
