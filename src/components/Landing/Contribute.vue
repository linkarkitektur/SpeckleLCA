        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <a href="https://github.com/linkarkitektur/SpeckleLCA">
                ...
                >
                    ...
                    >
                        <div
                            class="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-r from-[#0066CC] to-[#CCE5FF] opacity-[0.45]"
                            style="
                                clip-path: polygon(
                                    74.1% 44.1%,
                                    100% 61.6%,
                    ...
                    >
                        <div
                            class="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-r from-[#009999] to-[#CCFFFF] opacity-25"
                            style="
                                clip-path: polygon(
                                    74.1% 44.1%,
                                    100% 61.6%,
                    ...
                    <div class="relative mx-auto max-w-2xl lg:mx-0">
                        <figure>
                            <blockquote
                                class="mt-6 text-lg font-normal text-white sm:text-xl sm:leading-8"
                            >
                                <p>
                                    Join our efforts to democratise
                                    sustainability and LCA calculations by
                                    contributing towards this project.
                                    Everything made in this project is
                                    open-sourced and will continue to be open
                                    for all.
                                </p>
                            </blockquote>
                            <figcaption
                                class="mt-6 text-base text-lg text-white"
                            >
