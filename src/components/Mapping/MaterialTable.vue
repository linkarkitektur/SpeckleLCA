...
const showLifespanColumn = computed(() => calculationSettings.value.replaceB4WithProductionStages ?? true)
...
function updateLifespan(material: Product | Assembly, value: string | number) {
  if (!isAssembly(material)) {
    // Handle both string and number inputs
    material.lifespan = typeof value === 'string' ? 
