...
const groupings = ref<ResultItem[]>([
  { parameter: "parameters.category", displayName: "parameters.category", data: [] },
  { parameter: "material.name", displayName: "material.name", data: [] },
  { parameter: "material.metaData.materialType", displayName: "material.metaData.materialType", data: [] },
  { parameter: "parameters.code", displayName: "parameters.code", data: [] },
  { parameter: "parameters.speckle_type", displayName: "parameters.speckle_type", data: [] },
])
