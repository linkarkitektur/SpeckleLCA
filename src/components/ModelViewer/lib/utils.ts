...
export const ViewerInitializedPromiseKey: InjectionKey<Promise<boolean>> =
  Symbol('VIEWER_INSTANCE_INITIALIZED_PROMISE')
export const ViewerContainerKey: InjectionKey<HTMLElement> =
...
export function useInjectedViewer() {
  ...
  const isInitializedPromise = inject(
    ViewerInitializedPromiseKey
  ) as Promise<boolean>
