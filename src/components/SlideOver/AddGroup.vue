<template>
  <div class="space-y-12">
    <div class="pb-12">
      ...
      <div class="sm:col-span-6 my-4 p-4 border-dashed border-2 border-green-600 text-center styled-bread"
        @dragover.prevent
        @drop="handleDrop"
      >
  ...
  >
    ...
    <p v-else>
      Linked Geometry: {{ linkedGeo.name }}
    </p>
  </div>
 ...
 */
 function linkQuantities() {
  ...
  if (linkedGroup.value) {
    const quantities = calculateLinkedQuantities(linkedGroup.value, percentage.value)
