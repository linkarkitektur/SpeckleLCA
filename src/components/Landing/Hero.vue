        ...
        >
            ...
            >
                ...
                <p class="ml-1 mt-6 mr-10 text-lg leading-8 text-gray-700">
                    SpeckLCA enables cloud-based sustainability calculations
                    across the AECO value chain. Leveraging the power of open
                    data through the Speckle interoperability system, our vision
                    is to make the LCA process accessible to all.<br /><br />

                    Start using the software today, or join us in making it
                    better over on Github!
                </p>
