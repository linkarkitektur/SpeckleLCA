<template>
  <footer class="bg-white">
    <div class="mt-16 border-t border-gray-900/10 sm:mt-10 lg:mt-12 lg:flex lg:items-center lg:justify-between">
      <div class="mx-auto max-w-7xl px-6 py-12 flex items-center justify-between lg:px-8">
        ...
        <div class="mt-8 order-1 md:mt-0">
          <p class="text-center text-xs leading-5 text-gray-500">&copy; 2023, licensed under GPL-3.0.</p>
        </div>
      </div>
    </div>
  </footer>
